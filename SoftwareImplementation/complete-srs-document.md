...
|---------------|------------------------|----------|
| USR-01 | ระบบต้องรองรับการลงทะเบียนสมาชิกด้วย:<br>- ชื่อ-นามสกุล<br>- อีเมล (ใช้เป็น Username)<br>- รหัสผ่าน (กำหนด
•ความยาว 8-16 ตัวอักษร
•มีตัวอักษรพิมพ์ใหญ่อย่างน้อย 1ตัว
•มีตัวเลขอย่างน้อย 1 ตัว
•มีอักขระพิเศษอย่างน้อย 1 ตัว)<br>- เบอร์โทรศัพท์<br>- ที่อยู่ | High |
